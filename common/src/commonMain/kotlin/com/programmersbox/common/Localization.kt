...
public class Localization(
    ...
    internal val pills: (Double) -> String = { "$it pills" },
    ...
    internal val pillWeight: (Double) -> String = { "Pill Weight: $it" },
    internal val bottleWeight: (Double) -> String = { "Bottle Weight: $it" },
    ...
    internal val id: (String) -> String = { "ID: $it" },
    ...
    internal val searching: String = "Searching",
