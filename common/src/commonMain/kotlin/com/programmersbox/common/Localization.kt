...
public class Localization(
    ...
    internal val pills: @Composable (Double) -> String = { "$it pills" },
    ...
    internal val pillWeight: @Composable (Double) -> String = { "Pill Weight: $it" },
    internal val bottleWeight: @Composable (Double) -> String = { "Bottle Weight: $it" },
